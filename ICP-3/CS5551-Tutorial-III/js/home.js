...
myapp.controller( 'homeController', function ($scope, $http,$rootScope,$log, $window, Token, Facebook,$http,$location) {
    ...
    $scope.lookupFood = function () {
        ...
        $http.get( 'https://api.nutritionix.com/v1_1/search/' + $scope.food + '?results=0:1&fields=*&appId=33ae3982&appKey=cc0cb03c44bf271c37f372cc64d0d27e').success( function (data1) {
    ...
    $scope.getVenues = function () {
        ...
        if (food != null && food != "") {
          //  document.getElementById('div_ReviewList').style.display = 'none';
            ...
            //var apiLink = "https://stream.watsonplatform.net/text-to-speech/api/v1/synthesize?username=a78ae0df-f032-4345-9478-713e3c1b50cb&password=o2AixHuTJjWW&text=" + food;
            /*alert(apiLink);
            var handler = $http.get("https://stream.watsonplatform.net/text-to-speech/api/v1/synthesize?username=a78ae0df-f032-4345-9478-713e3c1b50cb&password=o2AixHuTJjWW&text="
                + food);
